 ...
 * @author Microsoft
 */
public class Rect_Bagi extends javax.swing.JFrame {

    /**
     * Creates new form Rect_Bagi
     */
    public Rect_Bagi() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Hasil pembagian (x/y):");
    ...
    private void jButtonHitungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonHitungActionPerformed
        ...
        float penyebut = (float)(Math.pow(c, 2) + Math.pow(d, 2));

        String hasilReal = Float.toString(((a*c)+(b*d))/penyebut);
        realHasil.setText(hasilReal);

        String hasilImajiner = Float.toString((-(a*d)+(b*c))/penyebut);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Rect_Bagi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
