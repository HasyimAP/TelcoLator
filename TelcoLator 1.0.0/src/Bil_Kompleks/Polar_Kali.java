 ...
 * @author Microsoft
 */
public class Polar_Kali extends javax.swing.JFrame {

    /**
     * Creates new form Polar_Kali
     */
    public Polar_Kali() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Hasil perkalian (x.y):");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Polar_Kali.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Polar_Kali().setVisible(true);
            }
        });
    }
